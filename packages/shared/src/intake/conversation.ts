  ...
  const capabilityNote =
    fields.channel === "train"
      ...
      : fields.channel === "show"
        ...
        : "将创建「航班查询/官方跳转演示」任务。当前「实时可售票/票价监控不可用」（无 Amadeus Flight Offers 等库存源；Aviationstack/OpenSky 仅时刻/ADS-B，不算可售/可抢）。购票请跳转航司或 OTA 官方；本系统不做自动出票/代收票款，也不会发送虚假「发现可购票」通知。";
